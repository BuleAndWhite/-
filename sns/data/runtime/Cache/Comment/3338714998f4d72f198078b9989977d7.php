...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('commentadmin/index');?>">关注列表</a></li>
    </ul>
    <form class="js-ajax-form" method="post">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($comments)): foreach($comments as $key=>$vo): ?><tr>
                    ...
                    <!--<td><a href="<?php echo U('Commentadmin/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a></td>-->
