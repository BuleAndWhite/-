...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo U('Commentadmin/reply_home');?>">推荐热门评论</a></li>
    </ul>
    <form class="well form-search" method="post" action="<?php echo U('Commentadmin/reply_del');?>">
    ...
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Commentadmin/recoveryReply');?>" data-subcheck="true" data-msg="你确定恢复吗？">恢复
            </button>
        </div>
