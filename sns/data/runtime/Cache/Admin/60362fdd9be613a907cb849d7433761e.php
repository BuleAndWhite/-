...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;">朋友圈推荐热门评论</a></li>
        <li><a href="<?php echo U('CircleOfFriends/circle_reply');?>">朋友圈评论管理</a></li>
        <li><a href="<?php echo U('CircleOfFriends/circle_reply_del');?>">朋友圈评论回收站</a></li>

    </ul>
    <form class="well form-search" method="post" action="<?php echo U('CircleOfFriends/circle_reply_home');?>">
    ...
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            ...
            <button class="btn sbtn-primary btn-small js-ajax-submit" type="submit"
