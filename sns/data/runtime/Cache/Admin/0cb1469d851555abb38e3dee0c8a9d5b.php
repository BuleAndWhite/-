...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo U('Information/post_reply_del');?>">评论回收站</a></li>
        <li><a href="<?php echo U('Information/post_reply_home');?>">推荐热门评论</a></li>
    </ul>
    <form class="well form-search" method="post" action="<?php echo U('Information/post_reply');?>">
    ...
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Information/recommendReply',array('recommend'=>1));?>" data-subcheck="true">推荐热门
            </button>
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Information/recommendReply',array('unrecommend'=>1));?>" data-subcheck="true">取消热门
            </button>
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Information/deleteReply');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?>
            </button>
        </div>
