...
<div class="wrap js-check-wrap">
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:;">推荐首页朋友圈</a></li>
	...
	<form class="js-ajax-form" action="" method="post">
		<div class="table-actions">
			<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('CircleOfFriends/unRecommend',array('unrecommend'=>1));?>" data-subcheck="true" data-msg="你确定取消首页推荐吗？">取消首页推荐</button>
			<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('CircleOfFriends/delete');?>" data-subcheck="true" data-msg="你确定删除吗？">删除帖子</button>
		</div>
		<table class="table table-hover table-bordered table-list">
			...
			<?php if(is_array($sofIshot)): foreach($sofIshot as $k=>$vo): ?><tr>
		...
		<div class="table-actions">
			<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('Information/trashInfo',array('unRecommend'=>1));?>" data-subcheck="true" data-msg="你确定要取消首页推荐吗？">取消首页推荐</button>
			<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('Information/delete');?>" data-subcheck="true" data-msg="你确定删除吗？">删除帖子</button>
		</div>
