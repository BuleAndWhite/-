...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('Information/circle_add');?>">添加帖子</a></li>
        <li ><a href="javascript:;">帖子管理</a></li>
    ...
    <form action="<?php echo U('Information/circleAddOne');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
        <div class="row-fluid">
            <div class="span9">
                <table class="table table-bordered">
                    ...
                    <input type="hidden" name="post[forum_id]" value="<?php echo ($forumId); ?>" />
                    <tr>
                        <th>内容</th>
                        <td>
            ...
            <div class="span3">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><input type="text" name="post[create_time]" value="<?php echo date('Y-m-d H:i:s',time());?>" class="js-datetime" style="width: 160px;"></td>
                    </tr>
                    <tr>
                        <th><b>状态</b></th>
                    </tr>
