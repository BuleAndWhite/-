...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;">朋友圈评论管理</a></li>
        <li><a href="<?php echo U('CircleOfFriends/circle_reply_del');?>">朋友圈评论回收站</a></li>
        <li><a href="<?php echo U('CircleOfFriends/circle_reply_home');?>">朋友圈推荐热门评论</a></li>
    </ul>
    <form class="well form-search" method="post" action="<?php echo U('CircleOfFriends/circle_reply');?>">
    ...
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('CircleOfFriends/recommendReply',array('recommend'=>1));?>" data-subcheck="true">推荐热门
            </button>
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('CircleOfFriends/recommendReply',array('unrecommend'=>1));?>" data-subcheck="true">取消热门
            </button>
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('CircleOfFriends/deleteReply');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?>
            </button>
        </div>
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($sofReply)): foreach($sofReply as $key=>$vo): ?><tr>
...
<script>
    function refersh_window() {
        ...
        if (refersh_time == 1) {
            window.location = "<?php echo U('CircleOfFriends/index',$formget);?>";
        }
    }
