...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;">朋友圈评论回收站</a></li>
    ...
    <form class="well form-search" method="post" action="<?php echo U('CircleOfFriends/circle_reply_del');?>">
    ...
    <form class="js-ajax-form" action="" method="post">
        <div class="table-actions">
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('CircleOfFriends/recoveryReply');?>" data-subcheck="true" data-msg="你确定恢复吗？">恢复
            </button>
        </div>
