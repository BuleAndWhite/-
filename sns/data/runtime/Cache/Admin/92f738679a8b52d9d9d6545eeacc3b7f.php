	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<!--
				<ul class="nav simplewind-nav pull-right" style="margin-right:85px;">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<span class="user-info">
								公众号管理
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							...
							<li><a href="javascript:openapp('/index.php?g=Admin&m=Weixin&a=index&menuid=163','163Admin','公众号管理',true);"> 公众号管理</a></li>
						</ul>
					</li>
				</ul>
				-->
