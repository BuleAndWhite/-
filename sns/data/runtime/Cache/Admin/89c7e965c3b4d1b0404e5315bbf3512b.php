...
<div class="wrap js-check-wrap">
    ...
    <form class="well form-search" method="post" action="<?php echo U('ManagementH5/mall_exports');?>">
    ...
    <form class="well form-search" id="mainform" action="<?php echo U('ManagementH5/h5_list');?>" method="post">
       ...
       电话号码：
        <input type="text" name="phone" style="width: 200px;" value="<?php echo ($post_data["order_id"]); ?>" placeholder="请输入被推广人电话号码">
...
<!--        <span style=" color:#1abc9c"><?php echo ($bonus["B"]); ?></span>&nbsp;-->
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <th width="120">父级微信昵称</th>
                <th width="120">用户电话</th>
                <th width="120">用户地址</th>
                <th width="120">填入时间</th>
            </tr>
            </thead>
            <?php $type=array("-1"=>"未支付","1"=>"已支付","2"=>"已发货","3"=>"交易完成"); $expediting=array("-1"=>"未催货","1"=>"已催货"); $is_vip=array("0"=>"不是会员(体验会员)","1"=>"单次(一次会员)","2"=>"半年(半年会员)","3"=>"一年(一年会员)","4"=>"两年(两年会员)","5"=>"三年(三年会员)","6"=>"艾灸推广员","7"=>"虚拟机主","8"=>"天使机主"); ?>
            <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                    ...
                    <td>
                        <a href="javascript:open_iframe_dialog('<?php echo U('comment/commentadmin/userListH5',array('unionid'=>$res['unionid']));?>','H5用户信息')"><span style="color:#e95d4e"><?php echo ($res["name"]); ?></span>（查看下级）</a>
                    </td>
                    <td>
                        <?php echo ($res["pname"]); ?>
                    </td>
