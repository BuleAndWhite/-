...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;" target="_self">添加专题</a></li>
        <li><a href="<?php echo U('Information/circle_list');?>">专题管理</a></li>
        <!--<li><a href="<?php echo U('Information/circle_recommend');?>" target="_self">圈子推荐</a></li>-->
        <li><a href="<?php echo U('Information/circle_del');?>" target="_self">专题回收站</a></li>
    </ul>
    <form action="<?php echo U('Information/circleAddPost');?>" method="post" class="form-horizontal js-ajax-forms"
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="post[type_id]">
                                <?php if(is_array($circleType)): foreach($circleType as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <th>标题</th>
                        <td>
                            <input type="text" style="width:400px;" name="post[name]" id="master_name" required
                                   value=""
                                   placeholder="请输入标题"/>
                                ...
                                Wind.use("artDialog", function () {
                                    art.dialog({
                                        ...
                                        button: [{
                                            ...
                                            name: '返回列表页',
                                            callback: function () {
                                                location = "<?php echo U('Information/add');?>";
                                                return true;
                                            }
                                        }]
                                    });
